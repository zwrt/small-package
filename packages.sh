...
git clone --depth 1 https://github.com/xiaorouji/openwrt-passwall/trunk/luci-app-passwall
...
git clone --depth 1 https://github.com/xiangfeidexiaohuo/extra-ipk/trunk/patch/wall-luci/luci-app-vssr ./luci-app-vssr
git clone --depth 1 https://github.com/xiangfeidexiaohuo/extra-ipk/trunk/patch/wall-luci/lua-maxminddb ./lua-maxminddb
...
git clone --depth 1 https://github.com/lisaac/luci-app-dockerman/trunk/applications/luci-app-dockerman ./luci-app-dockerman
git clone --depth 1 https://github.com/vernesong/OpenClash/branches/dev/luci-app-openclash ./luci-app-openclash
